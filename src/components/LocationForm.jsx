...
export const LocationForm = ({handleSubmit}) => {  
  return (    
        <form className='relative z-10 ' onSubmit={handleSubmit} action="">          
          ...
          <input id='search' className=' text-center border-2 border-r-0 border-green-400 focus:border-4 focus:border-green-400 sm:w-[70%] max-w-xl outline-none' type="number" placeholder='Type a location Id...' />                    
